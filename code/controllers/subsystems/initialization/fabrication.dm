/var/datum/controller/subsystem/fabrication/SSfabrication

/datum/controller/subsystem/fabrication
	name = "Fabrication"
	flags = SS_NO_FIRE
	init_order = SS_INIT_FABRICATION

	var/list/recipes =    list()
	var/list/categories = list()
	var/list/crafting_procedures_by_type = list()

/datum/controller/subsystem/fabrication/New()
	NEW_SS_GLOBAL(SSfabrication)
