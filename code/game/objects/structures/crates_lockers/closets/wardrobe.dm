...
/obj/structure/closet/wardrobe/pink/fill()
	..()
	new /obj/item/clothing/pants/jumpsuit/pink(src)
	new /obj/item/clothing/pants/jumpsuit/pink(src)
	new /obj/item/clothing/pants/jumpsuit/pink(src)
...
/obj/structure/closet/wardrobe/green/fill()
	..()
	new /obj/item/clothing/pants/jumpsuit/green(src)
	new /obj/item/clothing/pants/jumpsuit/green(src)
	new /obj/item/clothing/pants/jumpsuit/green(src)
	new /obj/item/clothing/shoes/sneakers/black(src)
	new /obj/item/clothing/shoes/sneakers/black(src)
...
/obj/structure/closet/wardrobe/white/fill()
	..()
	new /obj/item/clothing/pants/jumpsuit/white(src)
	new /obj/item/clothing/pants/jumpsuit/white(src)
	new /obj/item/clothing/pants/jumpsuit/white(src)
...
/obj/structure/closet/wardrobe/grey/fill()
	..()
	new /obj/item/clothing/pants/jumpsuit/grey(src)
	new /obj/item/clothing/pants/jumpsuit/grey(src)
	new /obj/item/clothing/pants/jumpsuit/grey(src)
	new /obj/item/clothing/shoes/sneakers/black(src)
	new /obj/item/clothing/shoes/sneakers/black(src)
...
/obj/structure/closet/wardrobe/mixed/fill()
	..()
	new /obj/item/clothing/pants/jumpsuit/red(src)
	new /obj/item/clothing/pants/jumpsuit/orange(src)
	new /obj/item/clothing/pants/jumpsuit/yellow(src)
	new /obj/item/clothing/pants/jumpsuit/green(src)
	new /obj/item/clothing/pants/jumpsuit/blue(src)
	new /obj/item/clothing/pants/jumpsuit/purple(src)
