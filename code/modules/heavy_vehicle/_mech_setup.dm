...
#define HARDPOINT_BACK_UTILITY "back mount"
#define HARDPOINT_BACK_COMBAT "back rig"//For missile pods and stuff that doesnt need to face forward
#define HARDPOINT_BACK_SUPERHEAVY "superheavy mount"//For very very big equipment and weapons
#define HARDPOINT_LEFT_UTILITY "left tool"
#define HARDPOINT_RIGHT_UTILITY "right tool"
#define HARDPOINT_LEFT_COMBAT "left arm"
#define HARDPOINT_RIGHT_COMBAT "right arm"
#define HARDPOINT_HEAD_UTILITY "head"
#define HARDPOINT_FRAME_UTILITY "frame"//Clamps and other equipment that take lots of space
