...
/datum/species/bug/type_c/New()
	..()
	equip_adjust = list(
		slot_l_hand_str = list(                                                              "[EAST]" = list("x" = 17, "y" = 7),  "[SOUTH]" = list("x" = 6, "y" = 8),  "[WEST]" = list("x" = -11, "y" = 9)),
		slot_r_hand_str = list(                                                              "[EAST]" = list("x" = 27, "y" = 9),  "[SOUTH]" = list("x" = 9, "y" = 8),  "[WEST]" = list("x" = -1,  "y" = 7)),
		slot_wear_id_str = list(                                                             "[EAST]" = list("x" = 18, "y" = 10), "[SOUTH]" = list("x" = 9, "y" = 10),                                    ),
		slot_l_ear_str = list(                                                                                                    "[SOUTH]" = list("x" = 9, "y" = 11), "[WEST]" = list("x" = -8,  "y" = 10)),
		slot_r_ear_str = list(                                                               "[EAST]" = list("x" = 24, "y" = 10), "[SOUTH]" = list("x" = 7, "y" = 11)                                      )
	)
