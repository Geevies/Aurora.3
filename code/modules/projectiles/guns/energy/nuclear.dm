...
/obj/item/gun/energy/pistol/hegemony
	...
	desc = "An upgraded variant of the standard energy pistol with two settings: Stun and Kill"
	icon_state = "epistolstun100"
	item_state = null	//so the human update icon uses the icon_state instead.
	fire_sound = 'sound/weapons/Taser.ogg'
	slot_flags = SLOT_BELT|SLOT_HOLSTER
	...
	firemodes = list(
		list(mode_name="stun", projectile_type=/obj/item/projectile/beam/stun, modifystate="epistolstun", fire_sound='sound/weapons/Taser.ogg'),
		list(mode_name="lethal", projectile_type=/obj/item/projectile/beam/pistol/hegemony, modifystate="epistolkill", fire_sound='sound/weapons/Laser.ogg')
		)